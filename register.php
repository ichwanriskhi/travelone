                ...
                <div class="card-body">
                  ...
                  if(isset($_GET['info'])){
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        <h5>Maaf</h5>
                        Nomor telepon tidak Boleh Kurang Dari 11 dan Lebih Dari 13
                    </div>
                    <?php } else if($_GET['info'] == "terdaftar"){ ?>
                        <div class="alert alert-warning alert-dismissible">
                          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            <h5>Maaf</h5>
                  ...
                  <form action="register_process.php" method="post" class="row g-3 needs-validation" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="acceptTerms">Saya setuju dan menerima <a href="#">S&K yang berlaku</a></label>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Sudah mempunyai akun? <a href="login.php">Masuk</a></p>
                      <p class="small mb-0"><a href="index.html">Kembali</a></p>
                    </div>
                  </form>
